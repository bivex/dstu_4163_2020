...
with SessionLocal() as session:
    ...
    payload = {{
        "doc_id": doc_id,
        "org_name": "Шевченко Катерина Петрівна",
        "doc_type": "Скарга",
        ...
        "is_electronic": True,
        "body": [
            "Я, Шевченко Катерина Петрівна, що проживаю за адресою: вул. Хрещатик, буд. 22, кв. 5, м. Київ, 01001,",
            "тел.: +38 (050) 123-45-67, e-mail: shevchenko.k@example.com,",
            "12 липня 2026 року особисто подала до чергової частини заяву про вчинення щодо мене кримінального правопорушення.",
            "Уповноваженими особами у встановлений статтею 214 КПК України 24-годинний строк відомості до ЄРДР внесені не були,",
            "жодного повідомлення мені не надходило, витяг з ЄРДР не видавався.",
            "У зв'язку з викладеним, керуючись ст. 303, 306 КПК України, ПРОШУ:",
            "1. Визнати бездіяльність уповноважених осіб незаконною.",
            "2. Зобов'язати їх невідкладно внести відомості про правопорушення до ЄРДР та повідомити мене.",
            "3. До матеріалів цієї скарги додаю: копію поданої заяви та підтвердження факту її отримання."
        ],
        "signature_position": "Заявниця",
        "signature_name": "К. П. ШЕВЧЕНКО",
        "signers": [
            {{"order_index": 0, "full_name": "Шевченко Катерина Петрівна", "position": "Заявниця", "signer_type": "person"}}
        ],
        "retention_years": 5,
        "_attachment_count": 2
    }}
