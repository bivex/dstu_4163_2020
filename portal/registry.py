...
# Літерний індекс справи за типом документа (Типова інструкція з діловодства,
# ПКМУ № 55/2018, п. реєстрації). Додається СУФІКСОМ через дефіс до порядкового
# номера: наказ з осн. діяльності «125-од», кадровий «12-к», розпорядження «8-р».
# Порожній суфікс — чистий порядковий номер.
_TYPE_SUFFIX = {
    "Наказ": "-од",  # накази з основної діяльності
    "Розпорядження": "-р",
    "Протокол": "",  # протоколи нумеруються без літери
    "Акт": "",
    "Лист": "",  # вихідні листи — окрема нумерація без літери
