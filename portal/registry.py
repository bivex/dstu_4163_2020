...
_TYPE_SUFFIX = {
    ...
    "Наказ про прийняття на роботу": "-к",  # кадрові
    "Наказ про звільнення": "-к",
    "Наказ про відпустку": "-в",  # відпустки/відрядження
    "Розпорядження": "-р",
    "Постанова": "-п",
    "Рішення": "-р",
    "Доручення": "-д",
    # Колегіальні / інформаційно-довідкові
    ...
    "Розпорядчий лист": "",
    # Нормативні / організаційні
    "Положення": "-пол",
    "Інструкція": "-і",
    "Посадова інструкція": "-пі",
    # Договірні
    "Договір": "-дог",
    "Угода": "-у",
    "Додаткова угода": "-ду",
