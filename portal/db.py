...
def _seed_default_templates() -> None:
    ...
    TEMPLATES = [
        ...
        dict(
            ...
            title_tpl="Заява",
            body=(
                "ЗАЯВА ГРОМАДЯНИНА — ПРАВИЛА (Закон № 393/96-ВР)\n\n"
                ...
                "СТРУКТУРА ТЕКСТУ:\n"
                "   1. Опис ситуації/обставин (стисло, факти без оцінок).\n"
                "   2. Правова підстава: «Відповідно до ст. [X] Закону України…»\n"
                "   3. ПРОШУ: (з нового рядка, по центру або із відступом)\n"
                "      конкретне прохання у пронумерованих пунктах.\n"
                "   4. Перелік додатків (копії документів).\n\n"
                "СТРОКИ РОЗГЛЯДУ (ст. 20 Закону № 393):\n"
                "   • Загальний строк — 30 днів.\n"
                "   • Без додаткового вивчення — 15 днів.\n"
                "   • Негайно — якщо вирішується на місці.\n\n"
                "ЗАБОРОНЕНІ ФОРМУЛЮВАННЯ:\n"
                "   • Образи, лайка — підстава для залишення без розгляду.\n"
                "   • Анонімні заяви не розглядаються.\n"
                "   • Повторні заяви без нових обставин — можуть бути відхилені."
            ),
        ),
        dict(
            category="stylevi", doc_type="Підказка",
        ...
        dict(
            ...
            title_tpl="[Назва документа]",
            body=(
                "РЕКВІЗИТИ ДОКУМЕНТА (ДСТУ 4163:2020)\n\n"
                "ПОСТІЙНІ РЕКВІЗИТИ БЛАНКУ:\n"
                "01 — Зображення Державного герба або емблеми організації\n"
                "07 — Найменування організації вищого рівня\n"
                "08 — Найменування організації\n"
                "09 — Найменування структурного підрозділу\n"
                "10 — Довідкові дані про організацію\n\n"
                "ЗМІННІ РЕКВІЗИТИ (заповнюються при складанні):\n"
                "11 — Дата документа (форматами: 19.07.2026 або 19 липня 2026 р.)\n"
                ...
                "25 — Заголовок до тексту (відповідає на питання «про що?»)\n"
                "26 — Відмітка про наявність додатків\n"
                "27 — Підпис (посада, особистий підпис, ПІБ)\n"
                "28 — Гриф погодження\n"
                "29 — Візи погодження\n"
                "32 — Відмітка про виконавця (ПІБ, тел.)\n\n"
                "РОЗМІЩЕННЯ:\n"
                "   Кутовий бланк: реквізити 07–10 у лівому верхньому куті.\n"
                "   Поздовжній бланк: реквізити 07–10 по центру.\n"
                "   Адресат (16): правий верхній кут, до 4 рядків."
            ),
        ),
        dict(
            category="stylevi", doc_type="Підказка",
