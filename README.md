...
Формат навантаження — детермінований рядок `ключ=значення;…`:

```
v=1;typ=QES;sn=58E2D9C1F0A4B7E3;sub=ПЕТРЕНКО Олександр Іванович;iss=КН ЕДП «Дія»;vf=01.01.2026;vt=01.01.2028;ts=13.06.2026 16:42:05 EET;st=VALID
```

де `typ` — QES (кваліфікований) / AES (удосконалений), `st` — VALID/INVALID за
Art.24. Роздільники у значеннях екрануються. Розмір рівно 21 мм за §5.10; права
межа лишає 10 мм поле за §6.2.
